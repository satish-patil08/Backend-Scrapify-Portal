...
public class ScrapifyCustomRepoImpl implements ScrapifyCustomRepo {
    ...
    @Override
    public ScrapifyDataMongoResponse getContentWithPagination(Long categoryId, ScrappingModel model, Integer page, Integer size) {
        ...
        if (model != null)
            criteria.add(Criteria.where("model").is(model));
